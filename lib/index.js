...
exports.create = function (Arrow, server) {
	...
	var readReplicaConnectionPoolIndex = 0;
	...
	return Connector.extend({
		...
		getReadReplicaPool: function getReadReplicaPool() {
			pool = this.readReplicaConnectionPools[readReplicaConnectionPoolIndex];
			readReplicaConnectionPoolIndex = (readReplicaConnectionPoolIndex + 1) %
			                                      this.readReplicaConnectionPools.length;
			return pool;
		},

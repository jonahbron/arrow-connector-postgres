...
exports.create = function (Arrow, server) {
	...
	return Connector.extend({
		...
		connectionPool: null,
		readReplicaConnectionPools: null,
		...
		connect: function (callback) {
			...
			if (this.config.readReplicaConnection) {
				this.readReplicaConnectionPool = new Pool(this.config.readReplicaConnection);
			}
		...
		disconnect: function (callback) {
			...
			if (this.readReplicaConnectionPool) {
				this.readReplicaConnectionPool.end();
			}
		...
		getConnection: function getConnection(callback, request, response, readOnly) {
			var pool;
			if (readOnly && this.readReplicaConnectionPool) {
				pool = this.readReplicaConnectionPool;
			} else {
